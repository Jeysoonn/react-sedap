...
// import FrameworkList from "./frameworkData"
// import FrameworkListSearchFilter from "./frameworkSearch"
import FrameworkListSearchFilter from "./Latihan"
import './tailwind.css';
    ...
    function ResponsiveWidth(){
        return (
            <div className="mb-4">
                ...
                <div className="flex flex-col md:flex-row md-4">
                    <div className="bg-red-400 w-full md:w-1/2 p-4">Kolom 1</div>
                    <div className="bg-blue-400 w-full md:w-1/2 p-4">Kolom 2</div>
                    <div className="bg-green-400 w-full md:w-1/2 p-4">Kolom 3</div>
                    <div className="bg-yellow-400 w-full md:w-1/2 p-4">Kolom 4</div>
                </div>
            </div>
        )
    }
